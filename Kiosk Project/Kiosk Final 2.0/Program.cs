...
namespace NHSKiosk
{
	...
	{
		#region ReturnsBank Data
		public class MyBank
		{
			public Bank[] data;
			//export data using a method
			public Bank[] ExportData()
			{
				return data;
			}
			public Bank[] DataProperty
			{
				get { return data; }
			}
		...
		#endregion
		#region Import Bank Data
		public class MyBankImp
		{
			public Bank[] data;
			
			public void ImportData(MyBank Source)
			{
				this.data = Bank.ExportData();
			}

			// Read property from Foo1
			public void ReadProperty(MyBankImp source)
			{
		...
		//-------------------------------------------------------METHODS-----------------------------------------------------------------
			...
			internal static decimal InputItemPrices() //Start of Input Item Prices
			{
				//Declaring variables
			...
			internal static decimal CashPayment(Bank bank, decimal total) //bank - contains currency info // 'total' - amount to be paid 
			{
				//Declaring Variables
			...
			internal static bool CheckBank(decimal changeOwed, Bank bank) //Start of Check Bank
			{
			...
			internal static void DispenseChange(decimal changeOwed, Bank bank, bool canPay) //Start of Dispense Change
			{
			...
			internal static string CardMerchantCheck(string cardNum) //Start of Card Name Check
			{
			...
			#region LuhnCheck
			internal static bool LuhnCheck(string cardNum) //Start of Luhn Check
			{
				//Declaring variables
			...
			#region CashBack
			internal static void CashBack(Bank bank) //Start of CashBack 
			{
				//Declaring Variables
				string response = "";
				int checker = 0;
			...
			internal static bool CheckCashBack(decimal amount, Bank bank) //Start of Check Cash Back
			{
				//Declaring Variables
				decimal owed = amount;
				int[] array = new int[12];
			...
			#region MoneyRequest
			internal static string[] MoneyRequest(string account_number, decimal amount) //Start of Money Request
			{
			...
			#region UsingCard
			internal static decimal UsingCard(Bank bank, decimal amount) //Start of Using Card
			{
				//Declaring Variables
				string response = "";
				string cardNum = "";
			...
			internal static void KioskTransactionReset(Bank kiosk) //Start of Transaction Reset
			{
				Console.WriteLine();
