    ...
    internal class CardPayCheck
    {
        ...
        public static decimal CardPay(decimal totalCost)
        {
            ...
            else
            {
                ...
                do
                {
                    Console.Write("ERROR \n Card was invalid, would you like to enter a new one?(y/n):");
                    answer = Console.ReadLine();
                    answer = answer.ToLower().Substring(0, 1);
                ...
                if (bankHasMoney == true)
                {
                    ...
                    if (numberCheck == totalCost)
                    {
                        ...
                        do
                        {
                            ...
                            Console.Write("Your card vendor only approved {0:C} towards your amount due. Would you like to enter a new card? ", numberCheck);
                            answer = Console.ReadLine();
                            answer = answer.ToLower().Substring(0, 1);
                            if (answer != "y" && answer != "n") Console.WriteLine("(Enter 'y' or 'n')");
                        } while (answer != "y" && answer != "n");
