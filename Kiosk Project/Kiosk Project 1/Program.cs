    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("(Press enter in a empty space when you are done)");
                Console.WriteLine("---------------------------------------");
                ...
                {
                    Console.WriteLine("---------------------------------------");
                    customerChoice = prompt("Will you be using Cash or Card");
        ...
        #region cash pay
        static void CashPay(decimal totalCost)
        {
        ...
        #region card pay
        static decimal CardPay(decimal totalCost)
        {
            //this tells
            Console.WriteLine("---------------------------------------");
