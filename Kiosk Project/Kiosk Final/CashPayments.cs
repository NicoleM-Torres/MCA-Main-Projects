...
namespace Kiosk_Final
{
    ...
    {
        public static void CashPay(decimal totalCost /*,bool Card*/) //added bool parameter
        {
            ...
            bool payGood = Bank.CheckBankCard(totalChange /*, Card*/); //added bool parameter
    ...
    internal class CashChange
    {
        ...
        public static decimal CalculateChange(decimal totalCost)
        {
            ...
            do
            {
                ...
                numericCheck = decimal.TryParse(userResponse, out numbercheck);
