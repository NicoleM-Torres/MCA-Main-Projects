namespace TicTacToe_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Clear();
            Console.WriteLine("__        _______ _     ____ ___  __  __ _____   _____ ___  \r\n\\ \\      / / ____| |   / ___/ _ \\|  \\/  | ____| |_   _/ _ \\ \r\n \\ \\ /\\ / /|  _| | |  | |  | | | | |\\/| |  _|     | || | | |\r\n  \\ V  V / | |___| |__| |__| |_| | |  | | |___    | || |_| |\r\n __\\_/\\_/_ |_____|_____\\____\\___/|_|  |_|_____|_  |_|_\\___/ \r\n|_   _|_ _/ ___|  |_   _|/ \\  / ___|  |_   _/ _ \\| ____|    \r\n  | |  | | |   _____| | / _ \\| |   _____| || | | |  _|      \r\n  | |  | | |__|_____| |/ ___ \\ |__|_____| || |_| | |___     \r\n  |_| |___\\____|    |_/_/   \\_\\____|    |_| \\___/|_____|    ");
            Console.WriteLine($"Welcome to Tic-Tac-Toe {player1Name} & {player2Name}! Select a column(a,b,c) and a row(0,1,2) to mark the spot you choose.\n");
            ...
            * drawn, or interrupted.*/
            ...
            /*loop where it alternates between two players taking turns to make a move on a game board. The game board is updated with each player's move, and after each move, it checks if there is a winner or if the game is a draw. If a player wins, it prints out the name of the winning player. If the game ends in a draw, it prints out "Draw!" and the loop terminates*/
            while (true)
            {
                placeMaker(n);

                int checkWinner = gameWon(n);
                ...
                if (turn % 2 == 0)
                {
                    n = playerTurn(player1X, n);
                } //END IF
                else
                {
                    n = playerTurn(player2O, n);
                } //END ELSE
                turn++;
            } //END WHILE
